 ...
 */
package org.sonatype.nexus.plugins.jenkins.internal.fixtures

import javax.inject.Provider
import org.sonatype.nexus.repository.manager.RepositoryManager
import org.sonatype.nexus.testsuite.testsupport.fixtures.RepositoryRule

class RepositoryRuleJenkins
    extends RepositoryRule
    implements JenkinsRepoRecipes
{
  RepositoryRuleJenkins(final Provider<RepositoryManager> repositoryManagerProvider) {
