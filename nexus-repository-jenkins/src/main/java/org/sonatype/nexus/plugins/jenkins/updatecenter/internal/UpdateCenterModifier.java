...
public class UpdateCenterModifier {
    ...
    public static final String CONNECTION_CHECK_URL_CONSTANT = "connectionCheckUrl";
        ...
        while (parser.hasNext()) {
            ...
            switch (event) {
                ...
                case START_OBJECT:
                    ...
                    break;
                case VALUE_STRING:
                    if(CONNECTION_CHECK_URL_CONSTANT.equals(key))
                        generator.write(key, nexusHost.toString());
                    else
