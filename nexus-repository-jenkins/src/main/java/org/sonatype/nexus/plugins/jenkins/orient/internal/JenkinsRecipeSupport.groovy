...
import org.sonatype.nexus.plugins.jenkins.internal.JenkinsSecurityFacet
...
/**
 * Support for Apk recipes.
 */
abstract class JenkinsRecipeSupport
    extends RecipeSupport
{
  @Inject
  Provider<JenkinsSecurityFacet> securityFacet
...
// https://updates.jenkins-ci.org/download/plugins/worktile/1.1.17/worktile.hpi
  static Matcher apkIndexMatcher() {
    buildTokenMatcherForPatternAndAssetKind('/update-center.json', AssetKind.JENKINS_INDEX, GET, HEAD)
  }
  // https://mirrors.aliyun.com/jenkins/war/2.362/jenkins.war"
  //https://updates.jenkins-ci.org/download/war/2.362/jenkins.war
  // /download/plugins/
