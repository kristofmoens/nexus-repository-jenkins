...
import org.sonatype.nexus.plugins.jenkins.updatecenter.internal.UpdateCenterModifier;
    ...
    implements JenkinsContentFacet
{
  ...
  public static ByteArrayOutputStream updateUrlReferenceForUpdateCenterJson(Payload payload, String baseUrlPath) {
    ...
    ByteArrayOutputStream baos = new ByteArrayOutputStream((int) payload.getSize());
    try {
