...
import org.proodos.nexus.plugins.jenkins.datastore.internal.JenkinsContentFacetImpl;
...
{
  public static final String REPOSITORY_BASEURL = "/repository/";
  public static final String PLUGINS_BASE_DIR = "/download";
  ...
  protected Content store(final Context context, final Content content) throws IOException {
    ...
    switch (assetKind) {
      ...
      case JENKINS_INDEX:
        ...
        String nexusBaseRepoUrl = "https://" + host + REPOSITORY_BASEURL + repoName + PLUGINS_BASE_DIR;
                                 ...
                                 final Payload payload) throws IOException
  {
    ...
    if (asset == null) {
      ...
      asset.formatAttributes().set(P_ASSET_KIND, AssetKind.ARCHIVE.name());
    }
                               ...
                               final Payload payload) throws IOException
  {
    ...
    if (asset == null) {
      ...
      asset.name(assetPath);
      asset.formatAttributes().set(P_ASSET_KIND, AssetKind.JENKINS_INDEX.name());
    }
